/*
 * ASSIGN_OVERFLOW Transaction Cross-Platform Test Vector Generator
 *
 * This test class generates valid and invalid ASSIGN_OVERFLOW transactions
...
/**
 * Generates ASSIGN_OVERFLOW transaction test vectors for Flutter cross-platform validation.
 *
 * ASSIGN_OVERFLOW Validation Rules (from TransactionUtils.isInternalTransactionBeanValid):
 ...
 */
public class AssignOverflowTransactionTestVectorGenerator {
    ...
    static void setUp() throws Exception {
        ...
        // Generate second key pair at index 1 (for to address - the overflow address)
        ...
        System.out.println("=== ASSIGN_OVERFLOW Transaction Test Vector Generator ===");
    ...
    // ========================================================================
    // ASSIGN_OVERFLOW VALID CASES
    // ========================================================================

    @Test
    void generateValidAssignOverflowTransactions() throws Exception {
        System.out.println("=== VALID ASSIGN_OVERFLOW TRANSACTIONS ===\n");

        List<Map<String, Object>> validCases = new ArrayList<>();

        // Case 1: Standard valid ASSIGN_OVERFLOW with message
        validCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_VALID_001",
            "Standard ASSIGN_OVERFLOW with message",
            publicKeyUrl64,      // from (main address)
            secondPublicKeyUrl64, // to (overflow address)
            "Assigning overflow node",  // message
            true  // expected valid
        ));

        // Case 2: ASSIGN_OVERFLOW with empty message
        validCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_VALID_002",
            "ASSIGN_OVERFLOW with empty message",
            publicKeyUrl64,
        ...
        // Case 3: ASSIGN_OVERFLOW with null message
        validCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_VALID_003",
            "ASSIGN_OVERFLOW with null message",
            publicKeyUrl64,
            secondPublicKeyUrl64,
            null,  // null message
            true
        ...
        // Case 4: ASSIGN_OVERFLOW with long message
        validCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_VALID_004",
            "ASSIGN_OVERFLOW with long message",
            publicKeyUrl64,
            secondPublicKeyUrl64,
            "This is a longer assignment message with additional details about the overflow node configuration.",
            true
        ));
    ...
    // ========================================================================
    // ASSIGN_OVERFLOW INVALID CASES
    // ========================================================================

    @Test
    void generateInvalidAssignOverflowTransactions() throws Exception {
        System.out.println("=== INVALID ASSIGN_OVERFLOW TRANSACTIONS ===\n");

        List<Map<String, Object>> invalidCases = new ArrayList<>();

        // Case 1: ASSIGN_OVERFLOW with null from
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_001",
            "ASSIGN_OVERFLOW with null from address",
            null,  // from is null
            secondPublicKeyUrl64,
            "Test message",
            false
        ...
        // Case 2: ASSIGN_OVERFLOW with empty from
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_002",
            "ASSIGN_OVERFLOW with empty from address",
            "",  // from is empty
            secondPublicKeyUrl64,
            "Test message",
            false
        ...
        // Case 3: ASSIGN_OVERFLOW with blank from (spaces)
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_003",
            "ASSIGN_OVERFLOW with blank from address (spaces only)",
            "   ",  // from is blank
            secondPublicKeyUrl64,
            "Test message",
            false
        ...
        // Case 4: ASSIGN_OVERFLOW with null to
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_004",
            "ASSIGN_OVERFLOW with null to address",
            publicKeyUrl64,
            null,  // to is null
            "Test message",
            false
        ...
        // Case 5: ASSIGN_OVERFLOW with empty to
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_005",
            "ASSIGN_OVERFLOW with empty to address",
            publicKeyUrl64,
            "",  // to is empty
            "Test message",
            false
        ...
        // Case 6: ASSIGN_OVERFLOW with blank to (spaces)
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_006",
            "ASSIGN_OVERFLOW with blank to address (spaces only)",
            publicKeyUrl64,
            "   ",  // to is blank
            "Test message",
            false
        ...
        // Case 7: ASSIGN_OVERFLOW with invalid to length (too short)
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_007",
            "ASSIGN_OVERFLOW with invalid to length (too short)",
            publicKeyUrl64,
        ...
        // Case 8: ASSIGN_OVERFLOW with invalid to length (wrong length, not 44 or 19840)
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_008",
            "ASSIGN_OVERFLOW with invalid to length (50 chars)",
            publicKeyUrl64,
        ...
        // Case 9: ASSIGN_OVERFLOW with both null
        invalidCases.add(createAssignOverflowTestCase(
            "ASSIGN_OVERFLOW_INVALID_009",
            "ASSIGN_OVERFLOW with both from and to null",
            null,
            null,
            "Test message",
            false
    ...
    @Test
    void outputFlutterTestVectorsAssignOverflow() throws Exception {
        System.out.println("=== ASSIGN_OVERFLOW TEST VECTORS FOR FLUTTER ===\n");

        // Create ASSIGN_OVERFLOW ITB
        InternalTransactionBean itb = BuilderITB.assignOverflow(
            publicKeyUrl64,       // from (main address)
            secondPublicKeyUrl64, // to (overflow address)
            "Cross-platform test",
        ...
        allVectors.put("testType", "ASSIGN_OVERFLOW_CROSS_PLATFORM");
    ...
    @Test
    void validateFlutterGeneratedAssignOverflow() throws Exception {
        System.out.println("=== VALIDATE FLUTTER-GENERATED ASSIGN_OVERFLOW TRANSACTION ===\n");

        // Flutter-generated values from assign_overflow_transaction_cross_platform_test.dart
        ...
        String flutterSignature = "ka_Q3ioJnBiG1JJWvLaXeFEMsz7yUt9vw4yQDnDcfywXPXv58j6ig_AAXzKv6fP07_CgD00Z1qeC_em8Jsx5CQ..";
        String flutterMessage = "{\"from\":\"4mfAa-hIJBU8_iU7IUDIgQpDZCpBVNp7oyCsMED6Y4A.\",\"to\":\"lnVYK3e51TYQPVEHQIQl1s6amHvS7__4U01p8vFSGfU.\",\"message\":\"Flutter-generated ASSIGN_OVERFLOW for Java validation\",\"notBefore\":1736942400000,\"redValue\":null,\"greenValue\":null,\"transactionType\":\"ASSIGN_OVERFLOW\",\"transactionHash\":\"flutter_generated_hash\",\"epoch\":null,\"slot\":null}";
        ...
        assertTrue(validation.isValidSyntax(), "Flutter-generated ASSIGN_OVERFLOW ITB should have valid syntax");
        assertEquals(KeyContexts.TransactionType.ASSIGN_OVERFLOW, parsedItb.getTransactionType());

        System.out.println("\n=== FLUTTER ASSIGN_OVERFLOW TRANSACTION VALIDATION PASSED ===");
    }
    ...
    /**
     * Creates a test case for ASSIGN_OVERFLOW transaction.
     */
    private Map<String, Object> createAssignOverflowTestCase(String testId, String description,
        ...
        itb.setTransactionType(KeyContexts.TransactionType.ASSIGN_OVERFLOW);
        itb.setFrom(from);
        itb.setTo(to);
    ...
    public static void main(String[] args) throws Exception {
        AssignOverflowTransactionTestVectorGenerator generator = new AssignOverflowTransactionTestVectorGenerator();
        setUp();

        if (args.length > 0 && args[0].equals("--validate-flutter")) {
            generator.validateFlutterGeneratedAssignOverflow();
        } else {
            generator.generateValidAssignOverflowTransactions();
            generator.generateInvalidAssignOverflowTransactions();
            generator.outputFlutterTestVectorsAssignOverflow();
        }
    }
}
