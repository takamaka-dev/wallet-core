...
import io.takamaka.wallet.utils.KeyContexts.TransactionType;
...
public class InternalTransactionBean implements Serializable {
    ...
    /**
     *
     * @return internal transaction timestamp this field is set from the author
     * of the transaction the maximum allowed time in which a transaction can be
     * included in a block, can be at most current time + 10 minutes.
     * Transactions with a lower timestamp than the block creation time are
     * discarded
     */
