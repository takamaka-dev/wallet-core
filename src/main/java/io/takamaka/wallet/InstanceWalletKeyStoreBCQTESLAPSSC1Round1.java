 ...
 * @author giovanni
 */
public abstract class InstanceWalletKeyStoreBCQTESLAPSSC1Round1  implements InstanceWalletKeystoreInterface {
//
...
//                    Logger.getLogger(InstanceWalletKeyStoreBCQTESLAPSSC1Round1.class.getName()).log(Level.SEVERE, null, ex);
//                }
//                isInitialized = true;
//            }
//        }
...
//                }
//                /*
//                QTESLAKeyGenerationParameters qteslaKeyGenerationParameters = new QTESLAKeyGenerationParameters(QTESLASecurityCategory.PROVABLY_SECURE_I, new SeededRandom(seed, KeyContexts.WALLET_KEY_CHAIN, i + 1));
//                keyPairGenerator.init(qteslaKeyGenerationParameters);*/
...
//                    QTESLAPublicKeyParameters publicKey = (QTESLAPublicKeyParameters) aPublic;
//                    UrlBase64.encode(publicKey.getPublicData(), baos);
...
//                    AsymmetricKeyParameter aPublic = keyPairAtIndex.getPublic();
//                    QTESLAPublicKeyParameters publicKey = (QTESLAPublicKeyParameters) aPublic;
//                    b64e.encode(publicKey.getPublicData(), baos);
