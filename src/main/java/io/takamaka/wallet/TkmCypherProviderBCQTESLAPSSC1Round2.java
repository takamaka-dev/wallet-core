...
import io.takamaka.crypto.tkmsecurityprovider.util.adaptor.r2.BCQTESLAPSSC1CypherBeanR2;
import io.takamaka.crypto.tkmsecurityprovider.util.adaptor.r2.QTR2CypherProvider;
 ...
 */
public class TkmCypherProviderBCQTESLAPSSC1Round2 {
    ...
    public static TkmCypherBean sign(AsymmetricCipherKeyPair keyPair, String message) {
        ...
        tcb.setValid(false);
        BCQTESLAPSSC1CypherBeanR2 result = QTR2CypherProvider.sign(keyPair, message);
    ...
    public static TkmCypherBean verify(AsymmetricCipherKeyPair keyPair, String signature, String message) {
        TkmCypherBean tcb = new TkmCypherBean();
        tcb.setValid(false);
        BCQTESLAPSSC1CypherBeanR2 result = QTR2CypherProvider.verify(keyPair, signature, message);
        tcb.setEx(result.getEx());
        tcb.setSignature(result.getSignature());
        tcb.setValid(result.isValid());
    ...
    public static TkmCypherBean verify(String publicKey, String signature, String message) {
        TkmCypherBean tcb = new TkmCypherBean();
        tcb.setValid(false);
        BCQTESLAPSSC1CypherBeanR2 result = QTR2CypherProvider.verify(publicKey, signature, message);
        tcb.setEx(result.getEx());
        tcb.setSignature(result.getSignature());
        tcb.setValid(result.isValid());
        return tcb;
