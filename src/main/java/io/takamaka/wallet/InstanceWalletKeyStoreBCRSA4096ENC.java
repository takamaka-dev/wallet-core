...
public class InstanceWalletKeyStoreBCRSA4096ENC implements InstanceWalletKeystoreInterface {
     ...
     */
    public InstanceWalletKeyStoreBCRSA4096ENC(String walletName, int nCharForSeed) throws UnlockWalletException, WalletEmptySeedException, WalletBurnedException {
        synchronized (constructorLock) {
            if (!isInitialized) {
                try {
                    currentWalletName = walletName + DefaultInitParameters.WALLET_EXTENSION;
