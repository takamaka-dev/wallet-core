...
public final class KeyContexts {
    ...
    public static final String RSA_PK_ENCRYPTION = "__RSA_PK_ENCRYPTION__";
    public static final String DETERMINISTIC_KEY_AGREEMENT = "__DKA__";
    /**
     * context string (fixed salt part) for pbkf function
     */
    public static final String FILE_ENCRYPTION_AES = "__FILE_ENCRYPTION_AES__";
    public static final String FILE_ENCRYPTION_SIGNING_RSA_GENERAL = "__FILE_ENCRYPTION_SIGNING_RSA_GENERAL__";
    public static final String FILE_ENCRYPTION_SIGNING_RSA_GENERAL_AES = "__FILE_ENCRYPTION_SIGNING_RSA_GENERAL_AES__";
    public static final String RSA_SIGN_AES = "__RSA_SIGN_AES__";
    public static final String ECDSA_SIGN_AES = "__ECDSA_SIGN_AES__";
    public static final String ECDH_SIGN_AES = "__ECDH_SIGN_AES__";
    public static final String RSA_ENCRYPT_AES = "__RSA_ENCRYPT_AES__";
    public static final String EC25519_SIGN = "__EC25519_SIGN_AES__";
    public static final String CV25519_ENCRYPT = "__EC25519_ENCRYPT_AES__";
    /**
     * context string (fixed salt part) for pbkf function
     */
    public static final String FILE_ENCRYPTION_IDENT_STRING = "__FILE_ENCRYPTION_IDENT_STRING_SCOPE__";
    public static final String FILE_ENCRYPTION_IDENT_STRING_NUM = "__FILE_ENCRYPTION_IDENT_STRING_NUM__";
    public static final String DETERMINISTIC_PASSWORD_GENERATION = "__DETERMINISTIC_PASSWORD_GENERATION_SCOPE__";
    public static final String DETERMINISTIC_PASSWORD_GENERATION_NUM = "__DETERMINISTIC_PASSWORD_GENERATION_NUM_SCOPE__";
    ...
    public static enum QrType {
        IMPORT_WORDS,
        IMPORT_ENCRYPTED_WORDS,
        IMPORT_ENCRYPTED_KEY_WORDS,

    }

    public static enum CrcType {
    ...
    public static enum TransactionType {
        ...
        S_CREATE_ACCOUNT,
        /**
         * install a jar for smart contracts
         */
        S_INSTALL_JAR,
        S_REGISTER_ADDRESS
    }
